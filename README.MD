...
1. Optional - create a folder called `esoapi` in the root of your addon project folder. Add a file within that folder called `local.lua` - add the following into that file:
```
--- @meta
--- @diagnostics disable
